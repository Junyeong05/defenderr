...
public class FootMan : BaseHero
{
    ...
    {
        Debug.Log($"[FootMan] Initialized {HeroName} Level {level}");
    ...
    protected override void DoWait()
    {
        ...
        if (framesSinceLastAttack >= attackIntervalFrames && UnityEngine.Random.Range(0f, 100f) < 10f)
        {
            ...
            {
                if (enemy.CompareTag("Enemy") && enemy.GetComponent<BaseHero>()?.IsAlive == true)
                {
                    enemyCount++;
                }
            }
    ...
    public override void TakeDamage(float damage)
    {
        ...
        if (Random.Range(0f, 100f) < blockChance)
        {
            ...
            Debug.Log($"[FootMan] Blocked! Reduced damage to {damage}");
    ...
    protected override void DoMeleeAttack()
    {
        ...
        {
            Debug.Log($"[FootMan] Stunning blow!");
            // TODO: 기절 효과 구현
        }
    }
    ...
    protected override void OnKillEnemy(BaseHero enemy)
    {
        ...
        Debug.Log($"[FootMan] Healed {healAmount} HP after kill!");
    }
    ...
    public void Taunt()
    {
        ...
        Debug.Log($"[FootMan] Taunted enemies in {tauntRadius} radius!");
    }
